...
public class SignUp extends AnchorPane {
    ...
    protected final PasswordField txtFieldRePassword;
    ...
    public SignUp(Stage stage) {
        ...
        txtFieldRePassword = new PasswordField();
        txtFieldName.textProperty().addListener((observable, oldValue, newValue) -> {
            if(!(observable.getValue().isEmpty()) && !(txtFieldPassword.getText().isEmpty()) && !(txtFieldRePassword.getText().isEmpty()))
                btnRegister.setDisable(false);
            else
                btnRegister.setDisable(true);
        });
        txtFieldPassword.textProperty().addListener((observable, oldValue, newValue) -> {
            if(!(observable.getValue().isEmpty()) && !(txtFieldName.getText().isEmpty()) && !(txtFieldRePassword.getText().isEmpty()))
                btnRegister.setDisable(false);
            else
                btnRegister.setDisable(true);
        });
        txtFieldRePassword.textProperty().addListener((observable, oldValue, newValue) -> {
            if(!(observable.getValue().isEmpty()) && !(txtFieldName.getText().isEmpty()) && !(txtFieldPassword.getText().isEmpty()))
                btnRegister.setDisable(false);
        ...
        txtFieldName.setId("signUpHere");
        txtFieldName.setStyle("-fx-border-radius: 20; -fx-border-color: #99a7b0; -fx-border-width: 0.5; -fx-text-fill: #99a7b0;");
        ...
        txtFieldPassword.setId("signUpHere");
        txtFieldPassword.setStyle("-fx-border-radius: 20; -fx-border-color: #99a7b0; -fx-border-width: 0.5; -fx-text-fill: #99a7b0;");
        ...
        txtFieldRePassword.setId("signUpHere");
        txtFieldRePassword.setStyle(" -fx-border-radius: 20; -fx-border-color: #99a7b0; -fx-border-width: 0.5; -fx-text-fill: #99a7b0;");
